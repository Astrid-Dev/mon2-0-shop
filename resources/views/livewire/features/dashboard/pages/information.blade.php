            ...
            <div class="profile__inner p-relative">
                ...
                <div class="row">
                    <div class="col-xxl-4 col-lg-4">
                        <livewire:features.dashboard.components.dashboard-menu :currentMenu="'nav-information-tab'"/>
                    </div>
                            ...
                            <div class="tab-content" id="profile-tabContent">
                                <div class="tab-pane fade show active" id="nav-information" role="tabpanel" aria-labelledby="nav-information-tab">
                                    @if(auth()->user()->isProvider())
                                        <livewire:features.dashboard.components.provider-information />
                                        <hr/>
                                    @endif
                                    <livewire:features.dashboard.components.user-information />
                                </div>
