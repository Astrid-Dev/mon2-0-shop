...
{{--                            </div>--}}
                        ...
                        <div class="profile__main-content">
                            <h4 class="profile__main-title">{{$provider->name}}</h4>
                            <p> {!! __('dashboard.profile.provider.you_have_notifications', [
                                    'count' => '<span>0</span>'
                                ]) !!}
                            </p>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="profile__main-logout text-sm-end">
                        <form method="POST" action="{{ route('logout') }}" x-data>
                            ...
                            <button type="submit" class="tp-logout-btn" @click.prevent="$root.submit();">{{ __('header.settings.logout') }}</button>
                        </form>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="profile__main-info-item">
                        <div class="profile__main-info-icon">
                            <span>
                               <span class="profile-icon-count profile-order">{{$provider->products_count}}</span>
                        ...
                        <h4 class="profile__main-info-title">{{ __('dashboard.profile.provider.products') }}</h4>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="profile__main-info-item">
                        <div class="profile__main-info-icon">
                                <span>
                                   <span class="profile-icon-count profile-download">{{number_format($provider->reviews_avg ?? 0, 1)}}</span>
                        ...
                        <h4 class="profile__main-info-title">{{ __('dashboard.profile.provider.review') }}</h4>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="profile__main-info-item">
                        <div class="profile__main-info-icon">
                            <span>
                               <span class="profile-icon-count profile-wishlist">{{$provider->reviews_count}}</span>
                        ...
                        <h4 class="profile__main-info-title">{{ __('dashboard.profile.provider.comments') }}</h4>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    <div class="profile__main-info-item">
                        <div class="profile__main-info-icon">
                            <span>
                               <span class="profile-icon-count profile-wishlist">{{auth()->user()->bookmarks_count}}</span>
                        ...
                        <h4 class="profile__main-info-title">{{ __('dashboard.profile.provider.bookmarks') }}</h4>
                    </div>
                </div>
            </div>
        </div>
