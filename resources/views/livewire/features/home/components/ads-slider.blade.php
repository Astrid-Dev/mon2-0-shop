                                ...
                                <div class="row align-items-center">
                                    <div class="col-xl-5 col-lg-6 col-md-6">
                                        <div class="tp-slider-content p-relative z-index-1">
                                            <span>{{ __('home.ads_slider.starting_at') }} <b>{{$adProduct->formatted_price->new}} XAF</b></span>
                                            <h3 class="tp-slider-title max-lines-4">{{$adProduct->name}}</h3>
                                            <p>{{ __('home.ads_slider.exclusive_offer') }}
                                                <span>-{{$adProduct->promotion->discount_percentage}}%
