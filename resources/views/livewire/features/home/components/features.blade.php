<div>
    <section class="tp-feature-area tp-feature-border-radius pb-70 pt-70">
        <div class="container">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                    <div class="tp-feature-item d-flex align-items-start">
                        ...
                        <div class="tp-feature-content">
                            <h3 class="tp-feature-title">{{ __('home.features.free_delivery.title') }}</h3>
                            <p>{{ __('home.features.free_delivery.description') }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                    <div class="tp-feature-item d-flex align-items-start">
                        ...
                        <div class="tp-feature-content">
                            <h3 class="tp-feature-title">{{ __('home.features.return_and_refund.title') }}</h3>
                            <p>{{ __('home.features.return_and_refund.description') }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                    <div class="tp-feature-item d-flex align-items-start">
                        ...
                        <div class="tp-feature-content">
                            <h3 class="tp-feature-title">{{ __('home.features.member_discount.title') }}</h3>
                            <p>{{ __('home.features.member_discount.description') }} 25 000 XAF</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
                    <div class="tp-feature-item d-flex align-items-start">
                        ...
                        <div class="tp-feature-content">
                            <h3 class="tp-feature-title">{{ __('home.features.support.title') }}</h3>
                            <p>{{ __('home.features.support.description') }}</p>
                        </div>
                    </div>
                </div>
            </div>
