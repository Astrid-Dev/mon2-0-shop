                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-3 col-md-4 col-sm-6">
                            <div class="tp-footer-widget footer-col-1 mb-50">
                                <div class="tp-footer-widget-content">
                                    ...
                                    <p class="tp-footer-desc">{{ __('footer.description') }}</p>
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                            <div class="tp-footer-widget footer-col-2 mb-50">
                                <h4 class="tp-footer-widget-title">{{ __('footer.my_account.title') }}</h4>
                                <div class="tp-footer-widget-content">
                                    <ul>
                                        <li><a href="#">{{ __('footer.my_account.favorites') }}</a></li>
                                        <li><a href="#">{{ __('footer.my_account.my_profile') }}</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                            <div class="tp-footer-widget footer-col-3 mb-50">
                                <h4 class="tp-footer-widget-title">{{ __('footer.information.title') }}</h4>
                                <div class="tp-footer-widget-content">
                                    <ul>
                                        <li><a href="#">{{ __('footer.information.about') }}</a></li>
                                        <li><a href="#">{{ __('footer.information.privacy_policy') }}</a></li>
                                        <li><a href="#">{{ __('footer.information.terms_and_conditions') }}</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                            <div class="tp-footer-widget footer-col-4 mb-50">
                                <h4 class="tp-footer-widget-title">{{ __('footer.talk.title') }}</h4>
                                <div class="tp-footer-widget-content">
                                    <div class="tp-footer-talk mb-20">
                                        <span>{{ __('footer.talk.description') }}</span>
                        ...
                        <div class="row justify-content-center align-items-center">
                            <div class="col-md-12">
                                <div class="tp-footer-copyright text-center">
                                    <p>© {{env('APP_NAME')}} {{now()->year}}, {{ __('footer.rights') }}.</p>
                                </div>
                            </div>
                        </div>
                    </div>
