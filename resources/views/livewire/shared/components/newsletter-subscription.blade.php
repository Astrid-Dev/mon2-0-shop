<div>
    <section class="tp-subscribe-area pt-70 pb-65 theme-bg p-relative z-index-1">
        <div class="tp-subscribe-shape">
            <img class="tp-subscribe-shape-1" src={{asset("assets/img/subscribe/subscribe-shape-1.png")}} alt="">
            <img class="tp-subscribe-shape-2" src={{asset("assets/img/subscribe/subscribe-shape-2.png")}} alt="">
            <img class="tp-subscribe-shape-3" src={{asset("assets/img/subscribe/subscribe-shape-3.png")}} alt="">
            <img class="tp-subscribe-shape-4" src={{asset("assets/img/subscribe/subscribe-shape-4.png")}} alt="">
            <!-- plane shape -->
            <div class="tp-subscribe-plane">
                <img class="tp-subscribe-plane-shape" src={{asset("assets/img/subscribe/plane.png")}} alt="">
            ...
            <div class="row align-items-center">
                <div class="col-xl-7 col-lg-7">
                    <div class="tp-subscribe-content">
                        <span>{{ __('newsletter.hint') }}</span>
                        <h3 class="tp-subscribe-title">{{ __('newsletter.title') }}</h3>
                    </div>
                </div>
                    ...
                    <div class="tp-subscribe-form">
                        <form action="#">
                            <div class="tp-subscribe-input">
                                ...
                                <button type="submit">{{ __('newsletter.submit') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
