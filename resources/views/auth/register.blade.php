...
@section('title'){{ __('register.small_title') }}@endsection
@section('content')
    <!-- register area start -->
                ...
                <div class="col-xl-6 col-lg-8">
                    <div class="tp-login-wrapper">
                        <div class="tp-login-top text-center mb-30">
                            <h3 class="tp-login-title">{{ __('register.title', ['appName' => env('APP_NAME')]) }}</h3>
                            <p>{{ __('register.have_account') }}  <span><a href="{{ LaravelLocalization::localizeURL('/login') }}">{{ __('register.login') }}</a></span></p>
                        </div>
                        <form class="tp-login-option" method="POST" action="{{ \LaravelLocalization::localizeURL('/register') }}">
                            @csrf
                            ...
                            <div class="tp-login-social mb-10 d-flex flex-wrap align-items-center justify-content-center">
                                <div class="tp-login-option-item has-google w-75">
                                    <a href="#" class="w-100">
                                        ...
                                        {{ __('register.register_in_with') }} Mon2-0
                                    </a>
                                </div>
                            </div>
                            <div class="tp-login-mail text-center mb-40">
                                <p>{{ __('register.register_with_email') }}</p>
                            </div>
                            ...
                            <div class="tp-login-input-wrapper">
                                <div class="tp-login-input-box">
                                    <div class="tp-login-input">
                                        <input id="username" type="text" name="username" placeholder="{{ __('register.username.placeholder') }}"
                                               maxlength="20" minlength="3" required
                                               autocomplete="username"
                                               value="{{(old('username'))}}">
                                    </div>
                                    <div class="tp-login-input-title">
                                        <label for="username">{{ __('register.username.label') }}</label>
                                    </div>
                                </div>
                                <div class="tp-login-input-box">
                                    <div class="tp-login-input">
                                    ...
                                    <div class="tp-login-input-title">
                                        <label for="email">{{ __('register.email.label') }}</label>
                                    </div>
                                </div>
                                <div class="tp-login-input-box" x-data="{passwordType: 'password'}">
                                    <div class="tp-login-input">
                                        <input class="w-100 pl-25" id="tp_password"
                                               ...
                                               :type="passwordType" placeholder="{{ __('register.password.placeholder') }}"
                                    ...
                                    <div class="tp-login-input-title">
                                        <label for="tp_password">{{ __('register.password.label') }}</label>
                                    </div>
                                </div>
                                <div class="tp-login-input-box" x-data="{passwordType: 'password'}">
                                    <div class="tp-login-input">
                                        <input class="w-100 pl-25"
                                    ...
                                    <div class="tp-login-input-title">
                                        <label for="tp_password">{{ __('register.confirm_password.label') }}</label>
                                    </div>
                                </div>
                            </div>
                            <div class="tp-login-suggetions d-sm-flex align-items-center justify-content-between mb-20 mt-20">
                                <div class="tp-login-remeber">
                                    <input id="terms" name="terms" type="checkbox">
                                    <label for="terms">
                                        {!! __('register.agree_terms', [
                                                'terms' => '<a target="_blank" href="'.route('terms.show').'" class="text-decoration-underline small">'.__('register.terms').'</a>',
                                                'policy' => '<a target="_blank" href="'.route('policy.show').'" class="text-decoration-underline small">'.__('register.policy').'</a>',
                                        ]) !!}
                                    </label>
                                </div>
                            </div>
                            <div class="tp-login-bottom">
                                <button type="submit" class="tp-login-btn w-100">{{ __('register.submit') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
